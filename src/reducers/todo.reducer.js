  ...
  switch (action.type) {
    ...
    case Actions.GET_TODOLIST.SUCCESS:
      ...
      return state
        ...
        .update("todoEntities", () =>
          fromJS(normalizedTodos.entities.Todo || {})
        );
    ...
    case Actions.ADD_TODOBOX.SUCCESS:
      ...
      return state
        ...
        .update("todoBoxIds", todoBoxIds =>
          todoBoxIds.push(normalizedAddedTodoBox.result)
        );
    ...
    case Actions.GET_TODOBOXS.SUCCESS:
      ...
      return state
        ...
        .update("todoBoxEntities", () =>
          fromJS(normalizeTodoBox.entities.TodoBox || {})
        );
