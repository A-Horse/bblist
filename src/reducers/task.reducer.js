...
export function task2(
  ...
  switch (action.type) {
    ...
    case Actions.GET_TASK_BOARD_SETTING.SUCCESS:
      return state.setIn(
        ["boardSettingMap", action.payload.boardId],
        fromJS(action.payload)
      );

    case Actions.TASKBOARD_SETTING_UPDATE.REQUEST:
      return state.updateIn(
        ["boardSettingMap", action.meta.taskBoardId],
        setting => {
    ...
    case Actions.GET_TASK_BOARD.SUCCESS:
      ...
      return state
        ...
        .update("cardMap", () =>
          fromJS(normalizedBoard.entities.TaskCard || {})
        );
    ...
    case Actions.GET_TASK_ALL_BOARD.SUCCESS:
      ...
      return state.update("boardMap", () =>
        fromJS(normalizedAllBoard.entities.TaskBoard)
      );
    ...
    case Actions.UPLOAD_TASK_BOARD_COVER.SUCCESS:
      return state.update("board", board =>
        board.merge(fromJS(R.omit(["id"], action.payload)))
      );

    case Actions.DESTORY_TASK_BOARD.SUCCESS:
      return state
        .delete("board")
        .deleteIn(["boardMap", String(action.meta.id)]);
