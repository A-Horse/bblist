...
const TodoPage = props => (
  <Bundle
    load={require("bundle-loader?lazy&name=todo-page!./Todo/TodoPage.container")}
  >
    {B => <B {...props} />}
  </Bundle>
);
...
const SettingPage = props => (
  <Bundle
    load={require("bundle-loader?lazy&name=setting-page!./Setting/SettingPage.container")}
  >
    {B => <B {...props} />}
  </Bundle>
);
...
const TaskBoardPage = props => (
  <Bundle
    load={require("bundle-loader?lazy&name=task-board-page!page/Task/Board/Board.container")}
  >
    {B => <B {...props} />}
  </Bundle>
);
...
const ProfilePage = props => (
  <Bundle
    load={require("bundle-loader?lazy&name=profile-page!page/Profile/ProfilePage.container")}
  >
    {B => <B {...props} />}
  </Bundle>
);
