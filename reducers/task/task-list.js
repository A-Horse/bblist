import {
  TASKLIST_PATCH_REQUEST,
  TASKLIST_PATCH_SUCCESS,
  TASKLIST_PATCH_FAILURE,
  TASKLIST_POST_REQUEST,
  TASKLIST_POST_SUCCESS,
  TASKLIST_POST_FAILURE,
  TASKTRACK_CHANGE_INDEX_SUCCESS
} from '../../actions/task/task-list';

import {
  TASKCARD_LEAVE_START,
  TASKCARD_LEAVE_DONE,
  TASKCARD_ENTER_START,
  TASKCARD_ENTER_DONE,
  TASKCARD_PATCH_REQUEST,
  TASKCARD_PATCH_SUCCESS,
  TASKCARD_PATCH_FAILURE,
  INSERT_VIRTUAL_CARD
